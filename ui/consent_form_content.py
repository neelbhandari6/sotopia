"""
Consent form content for the user study interface.
"""
...
## Interaction
You will engage in a conversation with an AI agent in a realistic social scenario. You will be given specific goals to achieve during the conversation. Please respond as yourself and engage naturally in the conversation.
...
## Benefits
Your participation will help us better understand how AI systems can interact with humans in a realistic manner.

## Contact
If you have any questions about this study, you should feel free to ask them by contacting us (via the MTurk interface or via email at maartensap@cmu.edu). If you have questions later, desire additional information, or wish to withdraw your participation please contact Maarten Sap via e-mail in accordance with the contact information listed above. If you have questions pertaining to your rights as a research participant; or to report concerns to this study, you should contact the Office of Research Integrity and Compliance at Carnegie Mellon University, referencing study number STUDY2023_00000299. Email: irb-review@andrew.cmu.edu. Phone: 412-268-4721.
